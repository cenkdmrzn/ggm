...
--
-- Table structure for table `ggm_client`
--

DROP TABLE IF EXISTS `ggm_client`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ggm_client` (
  `id` int(11) NOT NULL,
  ...
  `client_sort_order` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `ggm_client`
--

LOCK TABLES `ggm_client` WRITE;
/*!40000 ALTER TABLE `ggm_client` DISABLE KEYS */;
/*!40000 ALTER TABLE `ggm_client` ENABLE KEYS */;
UNLOCK TABLES;
